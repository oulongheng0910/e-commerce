  ...
  <div class="product-view">
    <div class="container">
      ...
      <div class="breadcrumb">
        ...
        <span>›</span>
        <span style="color: green">Seeds of Change Organic (ID: {{ $route.params.id }})</span>
      </div>
      ...
      <div class="product-detail">
        ...
        <div class="product-images">
          <div class="main-image">
            <img src="../assets/Mango.jpg" alt="Product" />
          </div>

          <!-- Thumbnail images -->
          <div class="thumbnails">
            <img src="../assets/orange.png" alt="Thumb 1" class="active" />
            <img src="../assets/subimage3.png" alt="Thumb 2" />
            <img src="../assets/subimage2.png" alt="Thumb 3" />
            <img src="../assets/subimage1.png" alt="Thumb 4" />
          </div>
        </div>
...
export default {
  name: 'ProductDetail',
  mounted() {
    console.log('Product ID from route:', this.$route.params.id)
  },
}
</script>
